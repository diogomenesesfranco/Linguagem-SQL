------------------------------------------------------------------------------------------------------------------------------------
-- CONECTAR NO DATABASE REFERENTE A TURMA
------------------------------------------------------------------------------------------------------------------------------------

-- DROPANDO OBJETOS, CASO JÁ EXISTAM
-- Estrutura de Clientes
if object_id('Vendas2013') is not null
	drop table Vendas2013
if object_id('Vendas2014') is not null
	drop table Vendas2014
if object_id('Vendas2015') is not null
	drop table Vendas2015
if object_id('Cliente') is not null
	drop table Cliente

-- Estrutura de Veículo
if object_id('InserirVeiculoVendas') is not null
	drop procedure InserirVeiculoVendas
if object_id('VendasAnuais') is not null
	drop table VendasAnuais
if object_id('Veiculo') is not null
	drop table Veiculo
if object_id('Modelo') is not null
	drop table Modelo
if object_id('Ano') is not null
	drop table Ano
if object_id('Mes') is not null
	drop table Mes
...
--select *from sys.objects where schema_id = schema_id('2103013')
